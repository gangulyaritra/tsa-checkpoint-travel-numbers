...
class TSAETL(DataExtractor):
    ...
    website_url = "https://www.tsa.gov/travel/passenger-volumes"
    historical_url = "https://www.tsa.gov/travel/passenger-volumes/{yyyy}"
...
def main():
    ...
    for year in range(start_year, current_year + 1):
        url = (
            ...
            else TSAETL.historical_url.format(yyyy=year)
        )
